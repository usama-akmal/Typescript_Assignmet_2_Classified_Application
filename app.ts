...
abstract class Advertisment {
    ...
    constructor(modal : number,postDate: string, postTime : string, title : string,price : number,phoneNumber : number, discription : string,author : string, imageUrl : string) {
        this.modal = modal;
    ...
    abstract ShowAdd(id:string) : void;
 ...
 * Vechical
 */
abstract class Vehical extends Advertisment {
    public engineSize : string;
    public noOfWheels : number;
    public color : string;

    constructor(modal: number, postDate: string, postTime : string, title : string,price : number,phoneNumber : number, discription : string,author : string,imageUrl : string,engineSize : string,noOfWheels : number,color : string) {
        super(modal,postDate, postTime, title, price, phoneNumber, discription, author,imageUrl);
...
class Car extends Vehical {
    ...
    constructor(modal: number, postDate: string, postTime : string, title : string,price : number,phoneNumber : number, discription : string,author : string,imageUrl : string,engineSize : string,noOfWheels : number,color : string,noOfDoors : number, typeOfCars : string) {
         super(modal,postDate, postTime, title, price, phoneNumber, discription, author,imageUrl,engineSize,noOfWheels,color);
        this.noOfDoors = noOfDoors;
        this.typeOfCar = typeOfCars;
    }
    ShowAdd(id:string) : void{
        var dataToAdd : string = "<li>"+
...
class Bike extends Vehical {
    public typeOfBike : string;
    constructor(modal: number, postDate: string, postTime : string, title : string,price : number,phoneNumber : number, discription : string,author : string,imageUrl : string,engineSize : string,noOfWheels : number,color : string, typeOfBike : string) {
         super(modal,postDate, postTime, title, price, phoneNumber, discription, author,imageUrl,engineSize,noOfWheels,color);
 ...
 * Electronics
 */
abstract class Electronics extends Advertisment {
    typeOfItem : string;
    constructor(modal : number,postDate: string, postTime : string, title : string,price : number,phoneNumber : number, discription : string,author : string,imageUrl : string,typeOfItem : string) {
        super(modal,postDate, postTime, title, price, phoneNumber, discription, author,imageUrl);
 ...
 * Computers
 */
abstract class Computers extends Electronics {
    rams : string;
    processor : string;
    powerSource : string;
    constructor(modal : number,postDate: string, postTime : string, title : string,price : number,phoneNumber : number, discription : string,author : string,imageUrl : string,typeOfItem : string,rams : string,processor : string,powerSource : string) {
        super(modal,postDate, postTime, title, price, phoneNumber, discription, author,imageUrl,typeOfItem); 
        this.rams = rams;
...
class Mobile extends Computers{
    ...
    constructor(modal : number,postDate: string, postTime : string, title : string,price : number,phoneNumber : number, discription : string,author : string,imageUrl : string,typeOfItem : string,rams : string,processor : string,powerSource : string,screenSize : string,builtInStorage : string) {
        super(modal,postDate, postTime, title, price, phoneNumber, discription, author,imageUrl,typeOfItem,rams,processor,powerSource); 
...
class Laptop extends Computers{
    ...
    graphicCard : string;
    constructor(modal : number,postDate: string, postTime : string, title : string,price : number,phoneNumber : number, discription : string,author : string,imageUrl : string,typeOfItem : string,rams : string,processor : string,powerSource : string,graphicCard : string) {
        super(modal,postDate, postTime, title, price, phoneNumber, discription, author,imageUrl,typeOfItem,rams,processor,powerSource); 
...
type MyType = Laptop | Mobile | Car | Bike;
